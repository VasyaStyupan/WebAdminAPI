...
def test_update_doorbell(signin_ba, signin_ua):
    update_doorbell(signin_ba, signin_ua)


def test_change_room_doorbell_settings(signin_ba, signin_ua):
    change_room_doorbell_settings(signin_ba, signin_ua)
...
def test_create_custom_day_party_unit_doorbell_level(signin_ba, signin_ua):
    create_custom_day_by_range_for_doorbell_unit_level(signin_ba, signin_ua)
...
def test_change_custom_day_by_range_for_doorbell_unit_level(signin_ba, signin_ua):
    change_custom_day_by_range_for_doorbell_unit_level(signin_ba, signin_ua)


def test_update_party_mode_schedule_on_room_level(signin_ba,signin_ua):
    update_party_mode_schedule_on_room_level(signin_ba, signin_ua)
...
def test_delete_custom_day_doorbell_unit_level(signin_ba, signin_ua):
    delete_custom_day_doorbell_unit_level(signin_ba, signin_ua)
